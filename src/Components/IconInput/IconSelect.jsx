...
export default function IconSelect({type, label, name,handleChange,icon, defaultValue, width,validation, options=[],name_field, name_value=false,...props}) {
    return (
        <div className="iconInput" style={{width: width+'%'}}>
            ...
            <div className="input-container">
                {icon}
                <select type={type} onChange={handleChange} name={name} defaultValue={defaultValue} {...props} >
                    {
