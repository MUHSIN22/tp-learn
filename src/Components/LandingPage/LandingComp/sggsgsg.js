<div className="col-100">
        <div className="row banner_txt sec_1 d-flex">
          <div className="col-40 mt-5 ">
            <div className="">
              <img className="section_1_img" src={img_sec} />
            </div>
          </div>
          <div className="col-40 common_in_section Section_1_left">
        ...
        <div className="row py-5 section_3 d-flex justify-between">
          <div className="col">
        ...
        <div className="row d-flex section_5 dflex">
          ...
          <div className="col-50 px-2 Section_5_left">
