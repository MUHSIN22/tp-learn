...
export default function DesignationForm() {
    ...
    function handleDesignationForm(evt) {
        ...
        if (evt.target.name === "current_working") {
            ...
            value = evt.target.value.replace(commaSeparatorRegex,',')
        }else{
    ...
    return (
        <div className="designation-form-wrapper">
            ...
            <div className="grid-1-1-1">
                ...
                <PlainInput isSalary={true} type="text" value={form.start_salary} name='start_salary'  handleChange={handleDesignationForm} label='Your starting package' placeholder='120000' />
            ...
            <div className="grid-1-1-1">
                ...
                <PlainInput isSalary={true} type="text" value={form.end_salary} name='end_salary'  handleChange={handleDesignationForm} label='Last drawn package' placeholder='180000' />
