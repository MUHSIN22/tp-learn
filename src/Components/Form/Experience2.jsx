...
export default function Experience2() {
    ...
    return (
        <>
            ...
            <div className="form-row">
                <CardRadioGroup autofill={companyDetails.scale_id !== ""} label='Select the scale of buisness?' name={'scale_id'} state={form} setState={setForm} option={buisnessScaleList} name_field={'scale_of_business_name'} disabled={companyDetails.scale_id !== ""} />
            </div>
            <div className="form-row">
